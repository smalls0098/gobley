...
import gobley.gradle.cargo.profiles.BuiltInCargoProfile
...
class CargoPackage(
     ...
     */
    fun outputDirectory(
        profile: CargoProfile = BuiltInCargoProfile.Dev,
        target: RustTarget? = null
    ): Directory {
        val targetDirectory = root.dir(metadata.targetDirectory)
        val targetSpecificDirectory =
            if (target != null) targetDirectory.dir(target.rustTriple) else targetDirectory
