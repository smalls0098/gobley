...
interface GloballyLockedTask : Task {
    @get:Internal
...
@InternalGobleyGradleApi
abstract class JvmLocalLockHolder : BuildService<BuildServiceParameters.None> {
 ...
 */
@InternalGobleyGradleApi
fun GloballyLockedTask.globalLock(identifier: String, action: () -> Unit) {
